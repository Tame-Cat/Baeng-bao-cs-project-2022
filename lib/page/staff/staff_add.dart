...
class StaffAdd extends StatefulWidget {
  ...
  StaffAdd({Key? key, required this.my_account}) : super(key: key);

  @override
  State<StaffAdd> createState() => _StaffAdd();
}

class _StaffAdd extends State<StaffAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('หน้าเพิ่มข้อมูลเจ้าหน้าที่'),
  ...
  Future register() async {
    ...
    pd.dismiss();
    Utils.showToast(context, "เพิ่มเจ้าหน้าที่สำเร็จ", Colors.green);

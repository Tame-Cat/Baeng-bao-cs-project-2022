...
class MainStaff extends StatefulWidget {
  ...
  String from;
  MainStaff({Key? key, required this.from, required this.my_account})
      : super(key: key);
  @override
  _MainStaff createState() => _MainStaff();
}

class _MainStaff extends State<MainStaff> {
  ...
  Widget build(BuildContext context) {
    final tabs = [
      HomePage(my_account: widget.my_account),
    ...
    if (selectedIndex == 0) {
      return FloatingActionButton(
        ...
        onPressed: () => Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => CategoryAdd(my_account: widget.my_account)),
        ),
